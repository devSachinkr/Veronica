...
export default function Home() {
  ...
  return (
    <main>
      <section className="relative bg-gradient-to-b from-slate-900 via-yellow-800 to-background-90">
        ...
        <div className="relative">
          <div className="container px-4 py-8">
            <div className="flex items-center justify-between">
              ...
              <Button className="bg-yellow-600 hover:bg-yellow-700 text-primary">
